  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 opacity-0 group-hover:opacity-100 transition duration-300 blur-2xl">
        ...
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-violet-500/70 rounded-full" />
        <div className="absolute top-0 left-0 w-24 h-24 bg-violet-500/70 rounded-full" />
      </div>
